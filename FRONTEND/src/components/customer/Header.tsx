    ...
    >
      <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
        ...
        >
          ...
          <span className="font-bold text-lg text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-cyan-600">
            SmartLog AI
          </span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-12">
          <a
            href="/"
            className="text-gray-600 hover:text-blue-600 text-sm font-semibold flex items-center gap-2 group"
          >
            <Home size={16} />
            Home
            <span className="h-0.5 w-0 group-hover:w-full bg-blue-600 transition-all duration-300"></span>
          </a>
          <a
                ...
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    {[
                      ...
                      {
                        title: 'Promotion',
                        desc: 'Get 20% off on your next shipment!',
                        time: '1 hour ago',
                      },
                      {
                        title: 'Support',
                        desc: 'Your ticket #789 has been updated',
                        time: '3 hours ago',
                      },
                    ].map((notif, idx) => (
                      <div
          ...
          {!isLoggedIn && (
            <div className="hidden md:flex items-center gap-4">
              <button
                ...
                className="text-gray-600 hover:text-blue-600 text-sm font-bold flex items-center gap-2 transition-colors"
              >
                <LogIn size={16} />
                Login
              </button>
              <button
                onClick={() => handleNavigation('/auth')}
                className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-2.5 rounded-xl hover:shadow-lg hover:shadow-blue-600/30 transition-all font-semibold text-sm"
              >
                Register
              </button>
            </div>
        ...
        <div className="lg:hidden bg-white border-t border-blue-100/50 px-8 py-4">
          ...
          {!isLoggedIn && (
            <div className="mt-4 space-y-2 border-t border-gray-100 pt-4">
              <button
                onClick={() => handleNavigation('/auth')}
                className="w-full py-2 text-gray-700 text-sm font-medium hover:text-blue-600"
              >
                Login
              </button>
              <button
          ...
          {isLoggedIn && (
            <div className="mt-4 space-y-2 border-t border-gray-100 pt-4">
              <button
                ...
                className="w-full py-2 text-left text-gray-700 text-sm"
              >
                Order History
              </button>
              <button
              ...
              <button
                onClick={handleLogout}
                className="w-full py-2 text-left text-red-600 text-sm font-medium"
              >
                Logout
              </button>
            </div>
